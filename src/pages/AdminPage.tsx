    ...
    <div className="w-full">
      <header className="mb-16 text-center md:text-left flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="font-black text-[#55CDFC] uppercase tracking-[0.5em] text-xs mt-3">
        ...
        <div className="xl:col-span-7 space-y-8">
          ...
          <div className="space-y-6">
            {challenges.map((c) => (
              <div
                key={c.id}
                className="duo-card bg-white p-10 flex flex-col md:flex-row justify-between items-center gap-8 transition-all hover:border-[#55CDFC] hover:shadow-xl"
              >
                <div className="flex-grow space-y-3">
                  <div className="flex items-center gap-4">
                    <span className="bg-blue-50 text-[#55CDFC] text-xs font-black px-4 py-1.5 rounded-full uppercase tracking-wider border-2 border-blue-100">
                      Week {c.week}
                    </span>
                    <h3 className="font-black text-2xl text-gray-800 tracking-tight">{c.title}</h3>
                  </div>
                  <p className="text-gray-500 font-bold text-base leading-relaxed line-clamp-2 italic">
        ...
        <aside className="xl:col-span-5 xl:sticky xl:top-10">
          <div className="duo-card bg-[#F1FBFF] border-[#55CDFC] p-12 space-y-10 shadow-lg">
            <div className="text-center space-y-2">
              ...
              <p className="text-xs font-bold text-[#55CDFC]/60 uppercase tracking-widest">
            ...
            <form onSubmit={handleAddChallenge} className="space-y-8">
              <div className="space-y-3">
                <label className="text-xs font-black text-[#55CDFC] uppercase ml-2 tracking-widest">
