...
const HomePage: React.FC = () => {
  ...
  const fetchHomeData = async () => {
    ...
    setChallenge(activeChallenge as Challenge | null);
    ...
    if (activeChallenge) {
      ...
      setCheckins((currentCheckins || []) as CheckIn[]);
    } else {
      setCheckins([]);
    }
      ...
      {challenge ? (
        <div className="space-y-6">
          <div className="text-center">
            <span className="bg-[#55CDFC] text-white font-black uppercase tracking-[0.2em] text-[9px] px-4 py-1.5 rounded-full mb-2 inline-block">
              Huidige Week
            </span>
          ...
          <div className="duo-card p-8 md:p-10 space-y-8">
            <div className="text-center space-y-2">
              ...
              <p className="text-[#777777] font-bold text-base leading-relaxed max-w-lg mx-auto italic">
            ...
            {challenge.video_url && (
              ...
              >
                ...
                <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-sm text-white px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest">
                  Video Instructie
                </div>
              </a>
            )}
